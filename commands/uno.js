...
const commands = {
    ...
    //         if (Client.activeGame) return channel.send(`There's already a game of ${Client.activeGame.name} going on.`)
    ...
    //         channel.send("The game of UNO was forcibly ended.");
    ...
    //     execute(target, channel, user, server, client) {
    //         if (!Client.activeGame) return;
    //         if (Client.activeGame.started) return channel.send("The game has already been started!");
